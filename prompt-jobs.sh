...
pjobs_remove()
{
    ...
    unset PJOBS_BEFORE_LIST PJOBS_CLEAR_SEQ PJOBS_CONFIG PJOBS_AFTER_CLEAR
    ...
    unset PJOBS_SAVED_JOBS PJOBS_TMP_SAVED_JOBS
...
if [ "$PJOBS_BASH" ]
then
    PJOBS_SAVED_JOBS=__uninitialized__
    PROMPT_COMMAND='PJOBS_TMP_SAVED_JOBS=$(jobs); if test "$PJOBS_SAVED_JOBS" != "$PJOBS_TMP_SAVED_JOBS"; then PJOBS_SAVED_JOBS=$PJOBS_TMP_SAVED_JOBS; PS1="$(SAVEDLCALL=$LC_ALL; export LC_ALL=C; echo "$PJOBS_SAVED_JOBS" | pjobs_gen_prompt; export LC_ALL="$SAVEDLCALL")"; PS1="${PS1}${PJOBS_BASE_SEQ}${PJOBS_AFTER_LIST}${PJOBS_CLEAR_SEQ}${PJOBS_AFTER_CLEAR}"; fi'
